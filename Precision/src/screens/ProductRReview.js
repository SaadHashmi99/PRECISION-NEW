            ...
            <View style={{margin: 10, marginTop: 30}}>
              <Grid>
                <Col size={5}>
                  ...
                  <Row style={[STYLES.RowView, {height: 50, backgroundColor: '#d7ed4e'}]}>
                ...
                <Col size={7}>
                  <Row style={[STYLES.RowView, {height: 60, backgroundColor: colors.SECONDARY}]}>
                    <Text style={[STYLES.RowText, {fontWeight: 'bold', color: '#000', fontSize: 16}]}>VIN</Text>
                  </Row>
                  <Row style={[STYLES.RowView, {height: 50, backgroundColor: '#ffffff'}]}>
                ...
                <Col size={17}>
                  ...
                  <Row style={[STYLES.RowView, {height: 50, backgroundColor: '#ffffff'}]}>
                    ...
                    />
                    <View style={{marginLeft: 6, backgroundColor: 'yellow', borderColor: 'blue', borderWidth: 2, borderRadius: 50, width: 20, height: 20}}></View>
                  </Row>
                  <Row style={[STYLES.RowView, {height: 50, backgroundColor: '#d7ed4e'}]}>
                    <Dropdown
                      style={[STYLES.inputReqGoodRows, {marginLeft: 5, marginTop: 16}]}
                      ...
                      placeholderStyle={{fontSize: 11, fontFamily: 'Montserrat-Regular'}}
                    />
                    <View style={{marginLeft: 6, backgroundColor: 'blue', borderColor: 'blue', borderWidth: 2, borderRadius: 50, width: 20, height: 20}}></View>
                  </Row>
                  <Row style={[STYLES.RowView, {height: 50, backgroundColor: '#ffffff'}]}>
                    <Dropdown
                      style={[STYLES.inputReqGoodRows, {marginLeft: 5, marginTop: 16}]}
              ...
              <TouchableOpacity onPress={() => navigation.navigate('ProductRPurchase')}>
                <Text style={[STYLES.appButton, {alignSelf: 'flex-end', marginRight: 10, marginTop: 40}]}>UPDATE PR</Text>
              </TouchableOpacity> 
            </View>
            <Modal
              transparent={true}
