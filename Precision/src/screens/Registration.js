            ...
            <Grid>
              <Col size={15}>
                <Row style={[STYLES.RowView, {height: 90, backgroundColor: colors.SECONDARY, borderTopLeftRadius: 15, elevation: 20}]}>
                  <Text style={[STYLES.RowText, {fontSize: 16, color: '#000'}]}>S No</Text>
                </Row>
              ...
              <Col size={20}>
                <Row style={[STYLES.RowView, {height: 90, backgroundColor: colors.SECONDARY}]}>
                  <Text style={[STYLES.RowText, {fontSize: 16, color: '#000'}]}>VIN No.</Text>
                </Row>
              ...
              <Col size={20}>
                <Row style={[STYLES.RowView, {height: 90, backgroundColor: colors.SECONDARY}]}>
                  <Text style={[STYLES.RowText, {fontSize: 16, color: '#000'}]}>STOCK RO</Text>
                </Row>
                <Row style={[STYLES.RowView, {height: 60, backgroundColor: '#ffffff'}]}>
              ...
              <Col size={30}>
                <Row style={[STYLES.RowView, {height: 90, backgroundColor: colors.SECONDARY}]}>
                  <Text style={[STYLES.RowText, {fontSize: 16, color: '#000'}]}>Reg Date</Text>
                </Row>
                <Row style={[STYLES.RowView, {height: 60, backgroundColor: '#ffffff'}]}>
              ...
              <Col size={25}>
                <Row style={[STYLES.RowView, {height: 90, backgroundColor: colors.SECONDARY, borderTopRightRadius: 15}]}>
                  <Text style={[STYLES.RowText, {fontSize: 16, color: '#000'}]}>PARTS</Text>
                </Row>
                <Row style={[STYLES.RowView, {height: 60, backgroundColor: '#ffffff'}]}>
