            ...
            <View style={{margin: 10, marginTop: 30}}>
              <Grid>
                <Col size={25}>
                  <Row style={[STYLES.RowView, {borderTopLeftRadius: 15, height: 60, backgroundColor: colors.SECONDARY}]}>
                    <Text style={[STYLES.RowText, {fontWeight: 'bold', color: '#000', fontSize: 16}]}>SUPPLIERS</Text>
                  </Row>
                ...
                <Col size={20}>
                  <Row style={[STYLES.RowView, {height: 60, backgroundColor: colors.SECONDARY}]}>
                    <Text style={[STYLES.RowText, {fontWeight: 'bold', color: '#000', fontSize: 16}]}>DEAL PRICE</Text>
                  </Row>
                  <Row style={[STYLES.RowView, {height: 70, backgroundColor: '#ffffff'}]}>
                    <Dropdown
                      style={[STYLES.inputReqQuotationRows, {marginLeft: 5, marginTop: 12}]}
                      data={data2}
                      labelField="label"
                      valueField="value"
                      placeholder="10,000"
                ...
                <Col size={17}>
                  <Row style={[STYLES.RowView, {height: 60, backgroundColor: colors.SECONDARY}]}>
                    <Text style={[STYLES.RowText, {fontWeight: 'bold', color: '#000', fontSize: 16}]}>DAYS</Text>
                  </Row>
                  <Row style={[STYLES.RowView, {height: 70, backgroundColor: '#ffffff'}]}>
                    <Dropdown
                      style={[STYLES.inputReqQuotationRows2, {marginLeft: 5, marginTop: 12}]}
                      data={data5}
                      labelField="label"
                      valueField="value"
                      placeholder="12"
                ...
                <Col size={25}>
                  ...
                  <Row style={[STYLES.RowView, {height: 70, backgroundColor: '#ffffff', flexDirection: 'column'}]}>
                    <TouchableOpacity>
                      <Text style={[STYLES.appButtonUsers, {alignSelf: 'center', fontSize: 8, color: '#ffffff', marginTop: 16}]}>GENERATE PO</Text>
                    </TouchableOpacity>
                    <TouchableOpacity>
                      <Text style={[STYLES.appButtonUsers, {alignSelf: 'center', fontSize: 8, color: '#ffffff', marginTop: 5}]}> REJECT QUOTATION</Text>
                    </TouchableOpacity>
                  </Row>
              ...
              <View style={{flexDirection: 'row'}}>
                <TouchableOpacity style={{marginTop: 20}}>
                  <Text style={[STYLES.appButton, {alignSelf: 'flex-start', bottom: 14}]}>ADD</Text>
                </TouchableOpacity> 
                <TouchableOpacity style={{marginTop: 20, marginLeft: 10}}>
                  <Text style={[STYLES.appButton, {alignSelf: 'flex-start', bottom: 14}]}>DELETE</Text>
                </TouchableOpacity> 
              </View>
              <TouchableOpacity onPress={() => navigation.navigate('ProductRReview')}>
                <Text style={[STYLES.appButton, {alignSelf: 'flex-end', marginRight: 10, marginTop: 20}]}>UPDATE PR</Text>
              </TouchableOpacity> 
            </View>
            <Modal
              transparent={true}
