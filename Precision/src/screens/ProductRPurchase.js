              ...
              <Grid>
                <Col size={10}>
                  <Row style={[STYLES.RowView, {borderTopLeftRadius: 15, height: 90, backgroundColor: colors.SECONDARY}]}>
                    <Text style={[STYLES.RowText, {fontWeight: 'bold', color: '#000', fontSize: 16}]}>S No</Text>
                  </Row>
                  <Row style={[STYLES.RowView, {height: 120, backgroundColor: '#ffffff'}]}>
                    <Text style={STYLES.RowText}>1.</Text>
                  </Row>
                  <Row style={[STYLES.RowView, {height: 120, backgroundColor: '#d7ed4e'}]}>
                ...
                <Col size={13}>
                  <Row style={[STYLES.RowView, {height: 90, backgroundColor: colors.SECONDARY}]}>
                    <Text style={[STYLES.RowText, {fontWeight: 'bold', color: '#000', fontSize: 16}]}>VIN No.</Text>
                  </Row>
                  <Row style={[STYLES.RowView, {height: 120, backgroundColor: '#ffffff'}]}>
                ...
                <Col size={14}>
                  <Row style={[STYLES.RowView, {height: 90, backgroundColor: colors.SECONDARY}]}>
                    <Text style={[STYLES.RowText, {fontWeight: 'bold', color: '#000', fontSize: 16}]}>PR RO</Text>
                  </Row>
                  <Row style={[STYLES.RowView, {height: 120, backgroundColor: '#ffffff'}]}>
                ...
                <Col size={15}>
                  <Row style={[STYLES.RowView, {height: 90, backgroundColor: colors.SECONDARY}]}>
                    <Text style={[STYLES.RowText, {fontWeight: 'bold', color: '#000', fontSize: 16}]}>PARTS</Text>
                  </Row>
                  ...
                  <Row style={[STYLES.RowView, {justifyContent: 'space-between', height: 120, backgroundColor: '#d7ed4e'}]}>
                ...
                <Col size={15}>
                  <Row style={[STYLES.RowView, {height: 90, backgroundColor: colors.SECONDARY, borderTopRightRadius: 15}]}>
                    <Text style={[STYLES.RowText, {fontWeight: 'bold', color: '#000', fontSize: 16}]}>ACTION</Text>
                  </Row>
                  <Row style={[STYLES.RowView, {justifyContent: 'space-between', height: 120, flexDirection: 'column', backgroundColor: '#ffffff'}]}>
                    <TouchableOpacity>
                      <Text style={[STYLES.appButtonUsers, {alignSelf: 'center', fontSize: 8, color: '#ffffff', marginTop: 16}]}>REVIEW</Text>
                    </TouchableOpacity>
                    <TouchableOpacity>
                      <Text style={[STYLES.appButtonUsers, {alignSelf: 'center', fontSize: 8, color: '#ffffff', marginTop: 5}]}> FORWARD FOR QUOTATION</Text>
                    </TouchableOpacity>
                    <TouchableOpacity>
                      <Text style={[STYLES.appButtonUsers, {alignSelf: 'center', fontSize: 8, color: '#ffffff', marginTop: 5}]}> FORWARD FOR ORDER</Text>
                    </TouchableOpacity>
                  </Row>
                  <Row style={[STYLES.RowView, {justifyContent: 'space-between', height: 120, flexDirection: 'column', backgroundColor: '#d7ed4e'}]}>
                    <TouchableOpacity>
                      <Text style={[STYLES.appButtonUsers, {alignSelf: 'center', fontSize: 8, color: '#ffffff', marginTop: 16}]}>REVIEW</Text>
                    </TouchableOpacity>
                    <TouchableOpacity>
