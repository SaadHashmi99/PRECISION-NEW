      ...
      <KeyboardAvoidingView style={STYLES.container} behavior="padding" enable={enableShift}>
        <View>
          ...
          <Text style={STYLES.Heading}>WORKSHOP</Text>      
            <Text style={STYLES.subHeading}>MECHANIC WORKSHOP</Text>
          <ScrollView>          
            ...
            <TouchableOpacity onPress={() => navigation.navigate('DetailerWorkshop')}>
              <Text style={[STYLES.appButton, {alignSelf: 'flex-end', marginRight: 10, marginTop: 20}]}>SUBMIT HOURS</Text>
            </TouchableOpacity> 
            <Modal
                transparent={true}
