        ...
        <Modal animationType="fade" transparent={true} visible={VINOne}>
          <DropShadow
            ...
            <View
              ...
              <Text style={[STYLES.RowText, {fontSize: 20, color: '#ffffff'}]}>
                VIN: 89321
              </Text>
              <TouchableOpacity
            ...
            <Grid style={{elevation: 15}}>
              ...
              <Col size={30}>
                <Row
                  ...
                  <Text
                    style={[STYLES.RowText, {color: '#ffffff', fontSize: 16}]}>
                    PARTS
                  </Text>
                </Row>
                <Row
        ...
        <View style={{margin: 10, marginTop: 20}}>
          <View
            ...
            <TouchableOpacity activeOpacity={0.7} onPress={() => Order()}>
              <View
                style={order == true ? STYLES.filterLine : STYLES.filterUnline}>
                <Text style={{fontSize: 14, color: '#000', fontWeight: 'bold'}}>
                  ORDERED
                </Text>
              </View>
            ...
            <Grid style={{marginTop: 10}}>
                ...
                <Modal
                  ...
                  <View
                    ...
                    <View
                      ...
                      <Image source={carImage} style={{ width: '100%', height: '65%' }} />
              ...
              <Col size={30}>
                ...
                <Row
                  ...
                  <Text style={[STYLES.RowText, {fontSize: 16}]}>HONDA CIVIC</Text>
                </Row>
                <Row
                  style={[
                    STYLES.RowView,
